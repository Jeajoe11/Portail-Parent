...
while(myUser === "" || myUser === null){
  ...
  myName2.textContent = "[ANONYME]".setAttribute("title", "Veuillez actualiser la page pour changer de nom");
};
if(!myUser === "" || myUser === null){
  ...
  myName.textContent = "Joël".setAttribute("title", myUser).setAttribute("capital", "");

  myName2.textContent = "Joël".setAttribute("title", myUser).setAttribute("capital", "");

  Container2.setAttribute("data-inserted", "");
}
else{
  myName.textContent = myUser.setAttribute("title", myUser).setAttribute("capital", "");
